...
public class Main extends JFrame {
	...
	protected void buildApp(){
		...
		JLabel displayArea = new JLabel("<html>Instruction Area: <br> Please select a function from the buttons below <br> Current Balance: P" + balance + "</html>");
	...
	withDraw1.addActionListener(new ActionListener(){
		public void actionPerformed(ActionEvent event) {
			if(balance >= 100){
				balance = balance - 100;
				displayArea.setText("<html>P100.00 Withrawn! <br><br>" + finishedTransaction() + "</html>");
				readyToEnter = false;
				System.out.println("User Has Withdrawn P100.00");
				updateTransactionHist("User Has Withdrawn P100.00");
				} else {
					displayArea.setText("<html> Your Balance is below P100.00. Unable to Withdraw!! <br><br>" 
		...
		withDraw2.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
				if(balance >= 500){
					balance = balance - 500;
					displayArea.setText("<html>P500.00 Withrawn! <br><br>" + finishedTransaction() + "</html>");
					readyToEnter = false;
					System.out.println("User Has Withdrawn P500.00");
					updateTransactionHist("User Has Withdrawn P500.00");
				} else {
					displayArea.setText("<html> Your Balance is below P500.00. Unable to Withdraw!! <br><br>" 
					+ finishedTransaction() + "</html>");
				}
		...
		withDraw3.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
				if(balance >= 1000){
					...
					displayArea.setText("<html>P1000.00 Withrawn! <br><br>" + finishedTransaction() + "</html>");
					readyToEnter = false;
					System.out.println("User Has Withdrawn P1000.00");
					updateTransactionHist("User Has Withdrawn P1000.00");
				} else {
					displayArea.setText("<html> Your Balance is below P1000.00. Unable to Withdraw!! <br><br>" 
					+ finishedTransaction() + "</html>");
				}
			}	
		});
		...
		deposit.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
					displayArea.setText("<html> Deposit Selected! <br> Please input an amount below or equal to P10000.00 and click enter! <br><br>" 
					+ finishedTransaction() + "</html>" );
					readyToEnter = true;
			}	
		});
		...
		enter.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
				if(readyToEnter == true){
					if(Integer.parseInt(getInputSequence()) > 10000){
						displayArea.setText("That input is greater than P10000.00!");
						clearInput();
						inputDisplay.setText("Input Display: ");
						readyToEnter = false;
			...
			updateBalance(Integer.parseInt(getInputSequence()));
						displayArea.setText("<html> You have deposited P" + getInputSequence() 
						+ "! <br><br>" + finishedTransaction() + "</html>");
						System.out.println("User Has Deposited P" + getInputSequence());
						updateTransactionHist("User Has Deposited P" + getInputSequence());
					}
					clearInput();
					inputDisplay.setText("Input Display: ");
					readyToEnter = false;
	...
	String finishedTransaction(){
		return "Instruction Area: <br> Please select a function from the buttons below <br> Current Balance: P" + balance;
	}
