...
public class Login extends JFrame {
	...
	String[] pin = {"123456","098765","453627","984673","245363"};
	int attempts = 3;
 //Change pin by logging off
  public Login(){
 //Basic Constructor Setup
    ...
    quit.addActionListener(new ActionListener(){
        ...
        if(pinString.equals(pin[0])){
					JOptionPane.showMessageDialog(null, "That pin is correct! Opening Account...");
					dispose();
					new Main();
				} 
                
         if(pinString.equals(pin[1])){
					JOptionPane.showMessageDialog(null, "That pin is correct! Opening Account...");
					dispose();
					new Main();
				}
                
          if(pinString.equals(pin[2])){
					JOptionPane.showMessageDialog(null, "That pin is correct! Opening Account  ...");
					dispose();
					new Main();
				}
                
          if(pinString.equals(pin[3])){
					JOptionPane.showMessageDialog(null, "That pin is correct! Opening Account...");
					dispose();
					new Main();
				}
                
           if(pinString.equals(pin[4])){
					JOptionPane.showMessageDialog(null, "That pin is correct! Opening Account...");
					dispose();
					new Main();
            } 
